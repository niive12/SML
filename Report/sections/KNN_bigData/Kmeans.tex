...
%\begin{tabular}{|l|p{1.8cm}|p{1.8cm}|p{1.8cm}|p{1.8cm}|p{1.8cm}|}\hline
%\multirow{2}{*}{Criteria} & \multirow{2}{*}{None} & \multicolumn{2}{|c|}{K-mean} & \multicolumn{2}{|c|}{Normalized K-mean}\\ \cline{3-6}
% & & it = 10 & it = 500 & it = 10 & it = 500 \\ \hline
%Pre-Processing Time*  & 0s & & 11m16s &  & 12m18s \\ \hline
%Classification Time** & 30m50s &  & 37.22s &  & 37.21s \\ \hline
%Success Rate** & 74.2\% &  & 53.3\% &  & 60.5\% \\ \hline
%\multicolumn{6}{|l|}{* of 60,000 elements} \\ 
%\multicolumn{6}{|l|}{** of 4,000 elements against the training set.} \\ \hline
%\end{tabular}
...
%The K-mean algorithm is run with K = 10 and 500 for comparison.
}
