...
% with 400 400, this point was shifted to 85\% and k = 7. It could be explained that to reduce the time taken, we pick 80\% instead as this is only approx 2\% worse and then k = 10 or similar.
