...
\begin{figure}[H]
\centering
\includegraphics[width=0.49\textwidth]{graphics/tree_performance_mix}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{graphics/tree_performance_all}
...
\begin{figure}[H]
\centering
\includegraphics[width=0.45\textwidth]{graphics/tree_prepared_vs_smooth_timing}
