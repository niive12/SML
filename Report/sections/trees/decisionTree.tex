...
To test the overall performance each person was used as test data to see how they successfully the data could be classified.
The training set consist of all people where the person in the test set is removed from the training set. 
