...
if(T){
	...
	save(IG, entropy_data, x_lab, file = "entropy_IG.RData")
} else {
	load(file = "entropy_IG.RData")
}
...
plot(1:pc_plot,IG[1:pc_plot], xlab="PC", ylab="Information Gain",type="l",lty=1, xaxt="n")
