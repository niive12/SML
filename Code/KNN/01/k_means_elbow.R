...
# legend("bottomright",test_name[1],cex=0.8,col=colors[1],lty=1)
# elbowpoint
elbowpoint = 4;
arrows(k[elbowpoint+2], raw_homogenity[elbowpoint-2], k[elbowpoint], raw_homogenity[elbowpoint], length = 0.10, angle = 30, col = 1:3)
text(k[elbowpoint+2], raw_homogenity[elbowpoint-2], "Elbow Point")
q = dev.off()
setEPS()
...
# legend("topright",test_name[1],cex=0.8,col=colors[1],lty=1)