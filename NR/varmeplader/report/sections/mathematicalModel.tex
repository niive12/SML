...
\begin{eqnarray}
Q1 &=& \int ^{\omega / 2}_{-\omega /2} (u(x)-I_1(x)) \partial x %\qquad \because I_1(x) = \int^{\omega/2}_{-\omega/2} F(x,y,d)v(y) \partial y 
\label{eq:Q1}\\
Q2 &=& \int ^{\omega / 2}_{-\omega /2} (v(y)-I_2(y)) \partial y % \qquad \because I_2(y) = \int^{\omega/2}_{-\omega/2} F(x,y,d)u(x) \partial x 
\label{eq:Q2}
\end{eqnarray}
